...
// ✅ Move menuItems ra ngoài để tránh re-create mỗi lần render
const menuItems = [
  {
    id: "dashboard",
    label: "Dashboard",
...
const AdminSidebar = ({ isOpen }) => {
  ...
  // ✅ Tính activeMenu trực tiếp từ location, không cần state
    ...
    <aside className="w-64 bg-white border-r border-gray-200 flex flex-col">
      ...
      <div className="h-16 flex items-center justify-center border-b border-gray-200">
        <div className="flex items-center gap-2">
          ...
          <span className="font-bold text-gray-800 text-sm">WRStudios Admin</span>
        </div>
      </div>
